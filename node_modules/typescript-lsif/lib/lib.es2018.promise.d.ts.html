<html>
  <head>
    <base href="./../../../">
    <title>lib.es2018.promise.d.ts - Sourcetree</title>
    ...
    <link rel="stylesheet" href="_dist/main.css?v=1632727967746">
  </head>
 ...
 */</span>
<span class="hljs-keyword">interface</span> <span id="lsif2987">Promise</span>&lt;T&gt; {
    <span class="hljs-comment">/**
     * Attaches a callback that is invoked when the Promise is settled (fulfilled or rejected). The
     * resolved value cannot be modified from the callback.
     * <span class="hljs-doctag">@param</span> onfinally The callback to execute when the Promise is settled (fulfilled or rejected).
     * <span class="hljs-doctag">@returns</span> A Promise for the completion of the callback.
     */</span>
    <span class="hljs-title function_">finally</span>(onfinally?: (<span class="hljs-function">() =&gt;</span> <span class="hljs-built_in">void</span>) | <span class="hljs-literal">undefined</span> | <span class="hljs-literal">null</span>): <span class="hljs-title class_">Promise</span>&lt;T&gt;
}
</code></pre>
    </div>
    ...
    <script src="_dist/main.js?v=1632727967746"></script>
  </body>
</html>
